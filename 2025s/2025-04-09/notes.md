...
<img src="marketshare.png" alt="screen reader marketshare" height="300px"/>
...
- Many common issues are easily fixable:
...
<!-- - `1`/`Shift+1` - next/prev h1 heading -->
<!-- - `2`/`Shift+2` - next/prev h1 heading -->
<!-- - ... -->
<!-- - `→`/`←` - read next/prev letter -->
<!-- - `↓`/`↑` - read next/prev line -->
